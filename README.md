...
[![build status](https://img.shields.io/travis/hoatle/react-redux-universal-hot-example/master.svg?style=flat-square)](https://travis-ci.org/hoatle/react-redux-universal-hot-example)
[![Dependency Status](https://david-dm.org/hoatle/react-redux-universal-hot-example.svg?style=flat-square)](https://david-dm.org/hoatle/react-redux-universal-hot-example)
[![devDependency Status](https://david-dm.org/hoatle/react-redux-universal-hot-example/dev-status.svg?style=flat-square)](https://david-dm.org/hoatle/react-redux-universal-hot-example#info=devDependencies)
...
[![Demo on Heroku](https://img.shields.io/badge/demo-heroku-brightgreen.svg?style=flat-square)](https://react-redux-example.herokuapp.com/)
...
https://react-redux-example.herokuapp.com/
